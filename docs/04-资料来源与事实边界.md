...
| 等级 | 来源 | 用途 |
|---|---|---|
| A | ROS 官方站点、REP、ROS Wiki 镜像、官方 GitHub | 平台边界、命令语义、核心概念、包说明 |
| B | 大学课程、长期作者教材、稳定开源课程 | 章节组织、实验粒度、教学节奏 |
| C | Robotics Stack Exchange、ROS Discourse、Autolabor、鱼香 ROS、古月居等社区资料 | 当前求助入口、中文表达、安装经验、课堂节奏、排障案例 |
...
ROS Answers 现在更适合作为历史问题检索材料，不应作为当前优先求助入口。Noetic EOL 后，教材应引导读者优先去仍活跃的平台核对问题、提问和查看公告；同时，历史答案仍可用于理解老项目和常见错误，但必须结合 Noetic/Focal 的版本边界判断是否仍适用。
