...
- [自测题与参考答案小册：Markdown 版](ROS1零基础自学指导书-自测题与参考答案小册.md)
- [自测题与参考答案小册：PDF 版](ROS1零基础自学指导书-自测题与参考答案小册.pdf)
...
本书的写法不是“命令速查表”，而是按 **概念 -> 命令/代码 -> 观察结果 -> 原因解释 -> 常见错误** 的顺序组织。每个重要概念都尽量配一个可运行实验、观察命令、文字化数据流说明或排障路径。
...
- [自测题与参考答案小册](ROS1零基础自学指导书-自测题与参考答案小册.md)：集中收录 10 个主体章节的自测题和参考答案，供学生课后独立练习与核对。
- [练习源文件目录](exercises/)：每章一份，便于后续单独维护题目和答案。
...
建议按章节顺序学习，不应跳过 Ubuntu、catkin 和运行管理部分：
...
自测题与参考答案已从正文中抽离，统一维护在独立练习小册中，避免占用主体教材篇幅。
